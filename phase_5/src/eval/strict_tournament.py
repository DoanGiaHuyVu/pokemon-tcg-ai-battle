...
class AgentWrapper:
    ...
    def select_action(self, obs):
        ...
        # Inject metrics into obs so the agent can use them
        ...
        if self.is_neural:
            ...
            if max_count > 1:
                ...
                try:
                    ...
                    # Strict mode exceptions — re-raise to crash the game
                    raise
    ...
    for i in range(num_games):
        ...
        while True:
            ...
            try:
                ...
                # Strict mode crash — count it and break
                print(f"Game {i} STRICT CRASH: {e}")
                crashes += 1
                break
            except IndexError:
                if obs_dict.get("current")["yourIndex"] == 0:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--agent", type=str, default="neural_v2_search",
                        choices=["random", "heuristic", "neural_v2", "neural_v2_search", "neural_v2_search_strict"])
