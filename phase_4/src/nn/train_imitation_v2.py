...
def train():
    ...
    dataset_path = os.path.join(os.path.dirname(__file__), "../data/dataset_v2.jsonl")
    if not os.path.exists(dataset_path):
        print(f"Dataset not found at {dataset_path}")
        return
        
    train_dataset = ImitationDataset(dataset_path, split="train")
    val_dataset = ImitationDataset(dataset_path, split="val")
    ...
    save_path = os.path.join(os.path.dirname(__file__), "../../models/imitation_v2.pt")
