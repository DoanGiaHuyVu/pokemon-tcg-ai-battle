...
class ImitationDataset(Dataset):
    def __init__(self, jsonl_path=None, max_cards=100, max_options=50, split="all", max_lines=20000):
        self.data = []
    ...
    def __getitem__(self, idx):
        ...
        options = step_data["obs"]["select"].get("option", [])
        ...
        global_features = self._parse_global_features(current)
        ...
        action_list = step_data.get("action", [0])
