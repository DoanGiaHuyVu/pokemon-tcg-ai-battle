...
from src.nn.neural_agent import agent as neural_v0_agent_func
from src.nn.neural_agent import my_deck as neural_deck
...
if __name__ == "__main__":
    ...
    parser.add_argument("--agent", type=str, default="neural_v1", choices=["random", "heuristic", "neural_v0", "neural_v1", "neural_v1_belief"])
